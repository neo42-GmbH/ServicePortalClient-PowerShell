...
<#
.SYNOPSIS
    Exports Deployment System Settings
.DESCRIPTION
    This demo script will show you the following cenario:
	Export the Settings for the specified Deployment System
...
# Export of the deployment settings for the Deployment System
Export-SpcDeploymentSettings -Session $spcSession -Path "$OutputDirectory\$deploymentSystem-Deployment-Settings.json" -DeploymentSystem $deploymentSystem
